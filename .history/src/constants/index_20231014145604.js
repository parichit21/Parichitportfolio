...
const projects = [
  ...
  },
  {
    name: "Crypto News",
    description:
      "creted cryptonews with the help of Crypto data API( free Api) and Crypto News API(free) to get all the crypto details and the latest news",
    tags: [
      {
        name: "react",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    description:
      "Created a Clone of a famous application Instagram, where you can upload photos and also you can upload a story ",
    tags: [
      {
        name: "react JS",
        color: "blue-text-gradient",
