...
const projects = [
  {
    name: "Dashbord",
    description:
      " created a Admin Dashboard, built with react, tailwind, react-icons, Syncfusion. It is full responsive and also has theme mode/color and this web-app contains multiple charts an apps",
    tags: [
      {
        name: "react",
