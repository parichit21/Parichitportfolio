...
const testimonials = [
  ...
  {
    testimonial:
      "Worked in different Timezone with other team members for the completions of high criticality project",
    name: "Chris Brown",
    company: "DEF Corp",
  },
  {
    testimonial:
      "optimized Script, to decrease the time to run perticular script for the testing  ",
    name: "Lisa Wang",
